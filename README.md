...
- Strict provisional ADR-005 register/prove/state HTTP client with real Base HPKE proof generation, bounded no-redirect responses, sequential roster paging, and transport eligibility only after the durable active certificate is present
