...
/**
 * Shortcut settings used to be a document of their own. Moving between them and the rest of the
 * settings reloaded the page, so every switch replayed its on/off transition and the top bar
 * replaced the version with a "back to settings" link. They are now the `#shortcut-settings`
 * section of the settings page and this module owns their behaviour only.
 */
